...
void circ_permutation_empty()
{
	...
	assert(es_util::is_circ_permutation(v1.begin(), v1.end(), v2.begin()));
}
...
void circ_permutation_true()
{
	...
	assert(es_util::is_circ_permutation(v1.begin(), v1.end(), v2.begin()));
	assert(es_util::is_circ_permutation(v1.begin(), v1.end(), v3.begin()));
}
...
void circ_permutation_false()
{
	...
	assert(!es_util::is_circ_permutation(v1.begin(), v1.end(), v2.begin()));
	assert(!es_util::is_circ_permutation(v1.begin(), v1.end(), v3.begin()));
	assert(!es_util::is_circ_permutation(v1.begin(), v1.end(), v4.begin()));
}
