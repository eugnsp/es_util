...
template<class Forward_iterator1, class Forward_iterator2, class Forward_iterator3, class Predicate>
bool is_circ_permutation(Forward_iterator1 first1, Forward_iterator2 last1, 
	Forward_iterator3 first2, Predicate pred)
{
	const auto equal = ::es_util::find_if(first1, last1,
		[&pred, &first2](const auto& v) { return pred(v, *first2); });
...
bool is_circ_permutation(Forward_iterator1 first1, Forward_iterator2 last1, Forward_iterator3 first2)
{
